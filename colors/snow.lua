...
local ok, snow_colorscheme = pcall(require, "snow")
if ok then
	-- Use the modular system with default configuration
	snow_colorscheme.setup()
	snow_colorscheme.load()
	return
end
...
local colors = {
	...
	terminal_bright_green = palette.gray4,
